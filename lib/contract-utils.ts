...
export const DEPLOYED_CONTRACTS: ContractConfig[] = [
  {
    ...
    isDeployed: true,
    deployedAt: '2024',
    explorerUrl: `https://amoy.polygonscan.com/address/${CONTRACT_ADDRESSES.AMOY.YLDToken}`,
  },
  {
    name: 'YieldVault V4',
    ...
    isDeployed: true,
    deployedAt: '2024',
    explorerUrl: `https://amoy.polygonscan.com/address/${CONTRACT_ADDRESSES.AMOY.YieldVaultV4}`,
  },
  {
    name: 'Risk Guard',
    ...
    isDeployed: true,
    deployedAt: '2024',
    explorerUrl: `https://amoy.polygonscan.com/address/${CONTRACT_ADDRESSES.AMOY.RiskGuard}`,
  },
  {
